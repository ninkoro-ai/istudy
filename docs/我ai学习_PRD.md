...
| 概念 | 实际值 | 说明 |
|---|---|---|
| 知识点总数 | **273** | pol 45 / eng 36 / s339 100 / s881 92（v2.3 按 2026 考试大纲校准） |
...
> ⚠️ **常量语义澄清**：`TOTAL = 90` 表示「90 天备考计划」，**不是**知识点数。营销页「273 个知识点 + 90 天计划」两者均正确，无冲突。
...
- 合计 **273** 个知识点（v2.3 按 2026 考试大纲校准后），顺序铺入 90 天。
...
### 14.7 变更记录（v2.3 · 按 2026 考试大纲校准题库）

依据《339农业知识综合一2026年考试大纲》《881作物栽培育种与种子科学2026年考试大纲》（逐页核对，见 `docs/OUTLINE_GAP_REPORT.md`）：

1. **881 新增 36 条**：作物种子学 23 条（种子生物学/检验/生产/加工贮藏整块补齐，对应约 50 分）；育种学 5 条（品种与 DUS、繁殖方式与品种类型、抗病虫机制、分子设计育种、两系法制种）；栽培学 8 条（分类与分区、生育期、感温感光、穗分化同伸、温度积温、需水临界期、育苗移栽、地膜覆盖与垄作）。
2. **339 新增 30 条**：植物学 10 条（藻类、苔藓、五界与世代交替、分类单位、常见科两组、叶生态类型、根瘤菌根、分枝与芽、三生生长）；植物生理 9 条（氮素同化、新型激素、激素互作、ABC 模型、自交不亲和、植物运动、果实成熟脱落、呼吸应用、PCD）；遗传学 11 条（核型、配子与双受精、无融合生殖、基因互作、交换值三点测验、性连锁、细菌遗传、噬菌体、PCR 工具酶、植物转化、基因组图谱与 C 值）。
3. **手写题**：新增 66 个知识点 × 4 题，手写题总量 140 知识点 / 764 题。
4. **题型**：`genQuiz` 由四类扩为七类——属于 / 正确的是 / 错误的是 / 数值 / **判断** / **填空** / **术语解释**（对应大纲填空、判断、术语解释题型）。
5. 知识点总数 207 → **273**；营销页、README、统计口径同步更新。
