...
## 附二：v2.3 按 2026 考试大纲校准题库（本报告生成后）

- 依据两份官方大纲（339/881，共 45 页）逐章比对，新增 66 个知识点：s339 70→100、s881 56→92，合计 **273**；
- 881 补齐整块「作物种子学」（23 条）+ 分子设计育种等育种/栽培缺口；339 补齐植物类群、常见科、新型激素、遗传学细节；
- 手写题 74→**140 知识点 / 764 题**；自动出题新增判断/填空/术语解释题型（共七类），207→273 全部可答题；
- 详细对照见 `docs/OUTLINE_GAP_REPORT.md`。
